...
const palavras: Palavras = {
  nome: 'Brincadeira do Alto e Baixo',
  intro: [
    'Uma proposta para cuidarmos melhor uns dos outros, para nos aproximar das pessoas que nos são queridas.',
  ...
  whatIs: [
    'O que é',
    'Uma atividade, em forma de brincadeira, que estimula cuidarmos melhor de pessoas queridas, conversando rapidamente sobre os altos e baixos do dia.'
  ],
  purpose: [
    'objetivo',
    'Incentivar diálogo entre as pessoas com objetivo de fortalecer vínculos emocionais de qualidade.',
    'Saber como as pessoas estão e permitir que elas saibam como estamos.'
  ],
  howItWorks: [
    'Funcionamento',
  ...
  recommendations: [
    'recomendações',
    'Proporcionar um clima em que cada pessoa se sinta acolhida e bem no grupo.',
    'Ser pontual, atraso é um desrespeito aos amigos.',
    'Falar uma pessoa de cada vez.',
    'Ouvir com atenção e empatia.',
    'Respeitar as falas e os silêncios.',
    'Transcender a vontade de julgar, criticar, concordar ou discordar da outra pessoa, inclusive em pensamentos.',
    'Evitar monopolizar a fala.',
    'Uso solidário do tempo, de modo a facilitar para que a pessoa fale livremente, o que dispensa  interromper, interferir a fala da outra pessoa ou dar conselhos.',
    ...
    'Ser paciente se alguém deixar de seguir as recomendações, no próximo encontro reforce-as sem expor a pessoa.'
  ],
  contribue: [
    'Contribua',
  ...
  faq: [
    ...
    'Quem são vocês?',
    'Ninguém em especial. Somos um grupo de pessoas que congregam várias formas de pensamento, inclusive religiosa e politicamente, mas que se juntaram para divulgar essa idéia por sentirem que estamos carentes de diálogo.',
    ...
    // 'nao quer participarxx
    // mais'

  ],
  download: 'Folder explicativo para compartilhar'
}
