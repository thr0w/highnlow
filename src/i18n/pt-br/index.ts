...
const palavras: Palavras = {
  ...
  intro: [
    'Uma proposta para cuidarmos melhor uns dos outros.',
  ...
  whatIs: [
    'O que é',
    'Uma brincadeira que estimula cuidarmos melhor de pessoas queridas, conversando rapidamente sobre os altos e baixos do dia.'
  ],
  purpose: [
    'objetivo',
